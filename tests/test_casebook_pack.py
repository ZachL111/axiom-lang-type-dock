"""Regression checks for the axiom-lang-type-dock casebook."""
...
from casebook.harness import assert_expected, axiom_lang_type_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(axiom_lang_type_dock_summary(), assert_expected())
